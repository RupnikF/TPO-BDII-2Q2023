CREATE SEQUENCE nro_cliente_seq AS integer START 100;
...
CREATE SEQUENCE nro_factura_seq AS integer START 400;
...
CREATE SEQUENCE codigo_producto_seq AS integer START 100;
